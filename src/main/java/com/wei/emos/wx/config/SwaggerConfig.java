...
/**
 * @author www
 * @date 2021/11/22 18:49
 * @description: 配置swagger2，// 开启swagger，否则不能使用@EnableSwagger2
 */
@Configuration
@EnableSwagger2
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        // ApiSelectorBuilder 用来设置哪些类中的方法会生成中REST API中
        ...
        // 对JWT的支持,当用户用swagger调用受JWT认证保护的方法,必须要先提交参数，比如令牌
        // 存储用户必须提交的参数
